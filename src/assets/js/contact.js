$(document).ready(function(){
    ...
    $(function() {
        $('#contactForm').validate({
            ...
            messages: {
                name: {
                    required: "poderia adicionar um nome, por favor",
                    minlength: "seu nome deve consistir em pelo menos 2 caracteres"
                },
                subject: {
                    required: "poderia adicionar um assunto, por favor",
                    minlength: "seu assunto deve consistir em pelo menos 4 caracteres"
                },
                number: {
                    required: "poderia adicionar um numero, por favor",
